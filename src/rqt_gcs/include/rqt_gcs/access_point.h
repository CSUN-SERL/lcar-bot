...
public:
    ...
    void SetImage(sensor_msgs::ImagePtr img){ image_ptr = img; }
    ...
    //Getter Functions
    sensor_msgs::ImagePtr GetImage() const { return image_ptr; }
...
private:
    ...
    sensor_msgs::ImagePtr      image_ptr;               //Access Point image
