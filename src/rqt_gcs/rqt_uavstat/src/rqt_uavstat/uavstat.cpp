#include <rqt_uavstat/uavstat.h>
#include <pluginlib/class_list_macros.h>
#include <QStringList>

namespace rqt_uavstat {
...
PLUGINLIB_DECLARE_CLASS(rqt_uavstat, MyPlugin, rqt_uavstat::MyPlugin, rqt_gui_cpp::Plugin)
//PLUGINLIB_EXPORT_CLASS(rqt_uavstat::MyPlugin, rqt_gui_cpp::Plugin)
