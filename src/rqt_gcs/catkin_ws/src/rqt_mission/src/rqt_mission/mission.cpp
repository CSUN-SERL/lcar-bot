#include <rqt_mission/mission.h>
#include <pluginlib/class_list_macros.h>
#include <QStringList>

namespace rqt_mission {
...
PLUGINLIB_DECLARE_CLASS(rqt_mission, MyPlugin, rqt_mission::MyPlugin, rqt_gui_cpp::Plugin)
//PLUGINLIB_EXPORT_CLASS(rqt_mission::MyPlugin, rqt_gui_cpp::Plugin)
