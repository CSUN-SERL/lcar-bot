...
void runPredictable()
{
   ...
   //////////4th Building///////////////////
    geometry_msgs::Pose target_ptRTB1 = setupWaypoint(0.75,-1.45,height,0);
   
    geometry_msgs::Pose target_ptRTB2 = setupWaypoint(0.5,-1.45,height,0);
    
   geometry_msgs::Pose target_ptRTR = setupWaypoint(1.25,-2.0,height,90);
   
   geometry_msgs::Pose target_ptRTT = setupWaypoint(2,-1.5,height,180);
   
   geometry_msgs::Pose target_ptRTL = setupWaypoint(1.3,-0.8,height,270);
    //////////5th Building///////////////////
   ...
   geometry_msgs::Pose target_ptMTB = setupWaypoint(0.5,-0.15,height,0);
   
   geometry_msgs::Pose target_ptMTL = setupWaypoint(1.25,0.7,height,270);
   //////////6th Building///////////////////
   geometry_msgs::Pose target_ptLTR1 = setupWaypoint(1.25,0.8,height,90);
   
   geometry_msgs::Pose target_ptLTR2 = setupWaypoint(1.25,0.7,height,90);
   ...
   //////////7th Building///////////////////
    ...
    geometry_msgs::Pose target_ptLMT2 = setupWaypoint(0.5,1.35,height,180);
    
   geometry_msgs::Pose target_ptLML = setupWaypoint(-0.15,2.0,height,270);
   
   geometry_msgs::Pose target_ptLMR = setupWaypoint(-0.25,0.55,height,90);
   
   geometry_msgs::Pose target_ptLMB = setupWaypoint(-1.0,1.35,height,0);
   ...
   geometry_msgs::Pose target_ptLBL = setupWaypoint(-1.6,2.15,height,270);
   
   geometry_msgs::Pose target_ptLAND = setupWaypoint(-1.9,-1.5,height,270);
