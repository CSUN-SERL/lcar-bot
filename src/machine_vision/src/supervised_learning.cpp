...
//
 ...
 int iteration_2; //number corresponds to extraction type
...
// {
//     cout << "trying callback\n";
//   try
//   {
//     cv::imshow("video capture", cv_bridge::toCvShare(msg)->image);
//     cv::waitKey(1);
//   //   cv_bridge::CvImageConstPtr cv_ptr = cv_bridge::toCvShare(msg);
//   //   //camera_image = cv_ptr->image;
//   //   cout << ("in image_callback\n");
//   //   if(cv_ptr->image.data){
//   //     cout << "should show image\n";
//   //     cv::imshow("video capture", Mat(cv_ptr->image));
//   //     cv::waitKey(1);
//   //   }
//   // //  else cout << "no image data\n";
//    }
...
//         img = src_copy(windows).clone();
//         Mat Roi = src_copy(windows);
//         Mat extract;
...
//     cout << "hello world\n";
//
//     const string modelLibPath = "LinearHOG.xml.xml";
//     cout << modelLibPath << "\n";
//     try{
...
//       cout << e << " "<< c << " " << t << "\n";
//       //svm->load<SVM>(modelLibPath);
//     }
//     catch(cv::Exception& e){
//       ROS_ERROR("Error loading svm file: %s", e.what());
//     }
...
//       Mat feature_copy = hog_features.reshape(1,1);
//         trainingdata.push_back(&feature_copy);
//         if(label != -1){
//             cout << N << "\n";
...
//         //imshow("video capture", camera_image);
//         if (waitKey(10) >= 0)
//             break;
//     }
// }
...
//                     detected_objects.push(&(img_clone));
//
//                 }
//
//
...
//         Mat diplay_clone = display->clone();
//         Mat Roi = diplay_clone(windows);
//         Mat extract;
//         resize(Roi, extract, img_size);
//         Mat res;
//         Mat train_data;
